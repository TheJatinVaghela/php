            ...
            <div class="row row-cols-1 row-cols-xs-2 row-cols-sm-2 row-cols-lg-4 g-3">
                        ...
                        <div class="card-body">
                            ...
                            <h5 class="card-title">Lorem, ipsum dolor sit amet consectetur adipisicing elit. Veniam
                                ...
                                <center>
                                    ...
                                    <div class="d-grid gap-2 my-4"> <a href="#" class="btn btn-warning">add to cart</a> </div>
                                    <br>
                    ...
                    <div class="card h-100 shadow-sm"> <img
                        ...
                        <div class="card-body">
                            <div class="clearfix mb-3">
                                   <span class="float-start badge rounded-pill bg-primary">Mac</span>
                                    <span
                ...
                <div class="col">
                    ...
                    <div class="card h-100 shadow-sm"> <img
                        ...
                        <div class="card-body">
                            <div class="clearfix mb-3">
                                     <span class="float-start badge rounded-pill bg-primary">apple</span>
                                   <span
                                    class="float-start badge rounded-pill bg-success">12354.00&euro;</span> <span
                ...
                <div class="col">
                    <div class="card h-100 shadow-sm"> <img
                            ...
                            <div class="card-body">
                                <div class="clearfix mb-3">
                                    <span class="float-start badge rounded-pill bg-primary">Dell</span> 
                                    <span class="float-start price-hp">12354.00&euro;</span> <span
    ...
    <script>
        const stars = document.querySelectorAll(".star");
            ...
            star.addEventListener("click", () => {
                const rating = star.getAttribute("title");
